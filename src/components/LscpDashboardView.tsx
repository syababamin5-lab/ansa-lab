...
export const LscpDashboardView: React.FC<LscpDashboardViewProps> = ({
  ...
  const sdmWorkload = [
    ...
    { id: 'ao-3', code: 'AO#3', name: 'Abud', role: 'Penguji / Analis 3', bookedTcu: 2.5, maxTcu: 8.0, percent: 31, status: 'Available', badgeBg: 'bg-emerald-600', barColor: 'from-emerald-500 to-teal-500', initials: 'AB', avatarBg: 'bg-emerald-600' },
